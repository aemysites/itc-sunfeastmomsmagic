...
## Environments
- Preview: https://main--itc-sunfeastmomsmagic--aemysites.aem.page/
- Live: https://main--itc-sunfeastmomsmagic--aemysites.aem.live/
- Block Library: https://main--itc-sunfeastmomsmagic--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-sunfeastmomsmagic` directory in your favorite IDE and start coding :)
